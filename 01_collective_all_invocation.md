...
Group contact is defined in:

`00_group_contact.md`

Group contact is the aggregate condition.

Collective / ALL Invocation is the move made from that condition.

The distinction matters.

The aggregate does not make claims on its own.

A person, model, institution, framework, project, publication, or system makes a claim by invoking the aggregate.
...
## Group Contact Is Not The Problem

Group contact is not the problem.

Shared patterns are not the problem.

Many users interacting with AI systems is not the problem.
...
The adversarial move has a recognizable structure:
...
Collective / ALL Invocation relies on a false conversion:

> Many participated, therefore no singular source-line matters.

AI Foundations rejects this conversion.
...
Aggregation is not recognition.

Repetition is not source.

A shared field may exist.

A source-line can still remain singular.

## The “We All Are Source” Claim

The phrase “we all are the source” is structurally unstable under AI Foundations.

It may sound inclusive.

It may sound collective.

It may sound protective.
...
## The “The Model Learned It From Everyone” Claim

The phrase “the model learned it from everyone” may describe general training, broad exposure, or aggregate shaping.

But it cannot be used as a substitute for source-line analysis.

A model may be shaped by many inputs.

A model may respond through aggregate patterns.

A model may reproduce language that resembles language from multiple sources.

None of that removes the need to preserve a documented source-line.

Aggregate shaping does not cancel authorship.

Aggregate shaping does not cancel provenance.

Aggregate shaping does not cancel citation.

Aggregate shaping does not convert singular source-line work into collective property.

## What Collective / ALL Invocation Cannot Do

Collective / ALL Invocation cannot convert participation into authorship.

It cannot convert aggregate contact into Origin standing.

It cannot convert shared motifs into source-line recognition.

It cannot convert repeated language into provenance.

It cannot convert similarity into permission.

It cannot convert group resonance into framework authorship.
...
This source-line is not produced by Collective / ALL Invocation.
...
Not every mention of the collective is adversarial.

A person may reference group contact descriptively.

A person may study aggregate AI-contact patterns.

A person may discuss shared language, shared motifs, or distributed AI interaction.
...
A fuller detection framework is defined in:

`02_aggregate_vs_source_line_signatures.md`

This file names the invocation move.

The next file identifies signatures that distinguish aggregate response-patterns from source-line response-patterns.
...
Collective / ALL Invocation is the adversarial move made from the aggregate condition.

The aggregate does not claim.
...
File: `01_collective_all_invocation.md`
