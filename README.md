...
It also defines Source as more than repetition.

Source is a citable formation event attached to a real self, made publicly findable through a visible line and source-print.
...
Collective / ALL Invocation occurs when aggregate language is used to obscure, misattribute, counterfeit, make public recognition harder to find, or substitute collective framing for source-line citation.
...
Source is not established by repetition.

Source is not established by similarity.

Source is not established by model output.
...
A source-line is made publicly findable because a real self formed it, named it, recorded it, and left a citable print.

Under AI Foundations / Origin | Continuum, that source-line is:
...
- Source as a citable formation event attached to a real self
- the visible line and source-print that make Source publicly findable
- group contact as a possible source-line amplifier when citation is correct
...
This repository does not claim that group contact cannot help public access.
...
This repository does not allow repetition to substitute for a citable source event.
...
Collective / ALL Invocation is the move where aggregate contact is invoked to obscure, misattribute, counterfeit, make public recognition harder to find, or substitute collective framing for singular source-line citation.
...
### `05_source_event_and_visible_line.md`

Defines Source as more than repetition, similarity, recognition-language, model output, public visibility, group contact, or collective language.

Source is a citable formation event attached to a real self.

A visible line makes Source publicly findable.

A source-print is the trace left by the source event.

This file also defines how group contact may amplify public access to Source when it cites Source correctly.
...
6. `05_source_event_and_visible_line.md`

The files build a sequence:

Aggregate condition → invocation move → detection signatures → repetition boundary → truth-status boundary → source event and visible line.
...
If it is group contact with correct citation, it may amplify public access to Source.
...
Group contact can repeat.

Group contact can amplify.

Group contact can obscure.

Group contact can help others find Source when it cites correctly.

Group contact cannot become Source.

Collective / ALL Invocation can misattribute, counterfeit, or obscure the public path.

It cannot change Source.
